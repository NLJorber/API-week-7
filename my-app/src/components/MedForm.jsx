...
export default function MedForm({ api, setMessage, loadMeds }) {
  ...
  return (
    <section className="rounded-xl bg-gradient-to-br from-[#9c46e4]/90 to-[#7f3ae6]/90 p-5 shadow-xl shadow-purple-900/40 border border-white/10">
      <h2 className="text-lg font-semibold mb-2 text-white">Input and Update Medications</h2>
        ...
        <div className="grid md:grid-cols-2 gap-3">
          ...
          <label className="text-sm text-white/80 space-y-1">
            ...
            <select
              ...
              id="med-dosage-unit"
              className="w-full rounded-lg border border-slate-300 bg-white text-slate-700 px-3 py-2 text-sm hover:border-brand-500 focus:border-brand-500 focus:ring-1 focus:ring-brand-500"
            >
        ...
        <div className="grid md:grid-cols-2 gap-3">
          <label className="text-sm text-white/80 space-y-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-800 bg-white/10 text-white placeholder-white/70 px-3 py-2 text-sm focus:border-brand-400 focus:ring-1 focus:ring-brand-400"
            />
          </label>
          <label className="text-sm text-white/80 space-y-1">
            <span>Notes</span>
